        ...
        <div className="border-4 border-black rounded-xl p-6 bg-white shadow-md max-w-4xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="flex flex-col">
                    ...
                    <button className="bg-pgreen text-white font-semibold px-6 py-2 rounded-full mt-2 hover:bg-green-700 transition">
                        Kirim
                    </button>
                </div>

                {/* Map */}
                <div className="flex flex-col bg-pyellow p-4 rounded-lg">
                    <div className="flex">
